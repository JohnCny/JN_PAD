...
function newUser1(addIntopiece){
	...
	$("#mainPage").html("<div class='title' id='mjjgl2'><img src='images/back.png'/>进件管理</div>"+  
			...
			"<span>客户影像资料采集</span>"+
			"</div>"+
			"<div class='box jjgl' id='khxxzlcj'  style='float:none;display:inline-block;margin-left:50px;'>" +
			"<img src='images/xxzlcj.png' />" +
			"<span>客户信息资料采集</span>"+
			"</div>"+
			"<p>"+
...
//alert(addIntopiece.productName);
	...
	$.get(wsHost+selectall,{customerId:addIntopiece.customerId},callbackresult);
	function callbackresult(json){
		var obj = $.evalJSON(json);
window.scrollTo(0,0);//滚动条回到顶端
$("#mainPage").html("<div class='title'><img src='images/back.png' onclick='newUser1("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>进件管理</div>"+  
"<div class='content'>" +
"<div class='jjstep'>" +
"<div class='step1' onclick='myjjgl()'>"+addIntopiece.productName+"</div>"+
"<div class='step3' id='khxxlb'>"+addIntopiece.chineseName+"</div>"+
...
"</tr>"+
"<tr>"+                             
"<td>个人信息<span class='label label-"+obj.geren+"'>"+obj.geren2+"</span></td>"+             
"<td>房产信息<span class='label label-"+obj.fangchan+"'>"+obj.fangchan2+"</span></td>"+
"<td>家庭信息<span class='label label-"+obj.jiating+"'>"+obj.jiating2+"</span></td>"+ 
"<td>车产信息<span class='label label-"+obj.chechan+"'>"+obj.chechan2+"</span></td>"+ 
"<td>联系人信息<span class='label label-"+obj.lianxiren+"'>"+obj.lianxiren2+"</span></td>"+ 
"<td>居住信息<span class='label label-"+obj.juzhu+"'>"+obj.juzhu2+"</span></td>"+
"</tr>"+
"<td>" +
"<input type='button' class='btn' value='添加' onclick='grxx_add("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"<input type='button' class='btn' value='查看' onclick='grxx_edit("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"</td>"+         
"<td>" +
"<input type='button' class='btn' value='添加' onclick='fcxx_add("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"<input type='button' class='btn' value='查看' onclick='fcxx_edit("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"</td>"+
"<td>" +
"<input type='button' class='btn' value='添加' onclick='jtxx_add("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"<input type='button' class='btn' value='查看' onclick='jtxx_edit("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"</td>"+
"<td>" +
"<input type='button' class='btn' value='添加' onclick='ccxx_add("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"<input type='button' class='btn' value='查看' onclick='ccxx_edit("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"</td>"+
"<td>" +
"<input type='button' class='btn' value='添加' onclick='lxrxx_add("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"<input type='button' class='btn' value='查看' onclick='lxrxx_edit("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"</td>"+   
"<td>" +
"<input type='button' class='btn' value='添加' onclick='jzxx_add("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"<input type='button' class='btn' value='查看' onclick='jzxx_edit("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"</td>"+
"</tr>"+                           
"</table>"+
...
"<td>企业开户信息<span class='label label-"+obj.kaihu+"'>"+obj.kaihu2+"</span></td>"+            
...
"</td>"+
"<td>" +
"<input type='button' class='btn' value='添加' onclick='qyywxx_add("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"<input type='button' class='btn' value='查看' onclick='qyywxx_edit("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"</td>"+
"<td>" +
"<input type='button' class='btn' value='添加' onclick='qydpxx_add("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"<input type='button' class='btn' value='查看' onclick='qydpxx_edit("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"</td>"+
"<td>" +
"<input type='button' class='btn' value='添加' onclick='qykhxx_add("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"<input type='button' class='btn' value='查看' onclick='qykhxx_edit("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"</td>"+
"<td>" +
"<input type='button' class='btn' value='添加' onclick='qyqtxx_add("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"<input type='button' class='btn' value='查看' onclick='qyqtxx_edit("+ JSON.stringify(addIntopiece).replace(/"/g, '&quot;') +")'/>" +
"</td>"+
"</tr>"+
"</table>"+
